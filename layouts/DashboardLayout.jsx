            ...
            <div style={{ marginTop: "20px" }}>
              {SideNavInfo["admin"].map((info, key) => (
                <Link href={info.link} key={key}>
                  <div className={`${styles.menuItem} ${info.activeKey === props.pageInfo.activeMenu ? styles.activeMenuItem : ""}`} style={navOpen ? {} : { margin: "auto", width: "100%" }}>
                    {info.icon}
      ...
      <div style={{ position: "relative" }}>
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            <SearchBar className={styles.searchBar} setValue={console.log} placeholder="Search" search />
