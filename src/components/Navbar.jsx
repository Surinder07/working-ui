  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar gap-6">
      ...
      <div className="sm:flex hidden justify-end items-center flex-1 gap-6">
        <button
          type="button"
          className="py-2.5 px-5 mr-2 mb-2 text-[17px] font-medium text-[#0091D0] focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
        >
          Log in
        </button>
