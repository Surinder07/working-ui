        ...
        <div className={`${EditableInputStyles.container} ${props.className}`} style={props.style}>
            ...
            {props.type === "mobile" &&
                (props.editOn ? (
                    ...
                    <p>
                        {props.initialValue.countryCode} - {props.value.mobile}
                    </p>
                ))}
            {props.type === "time" &&
                (props.editOn ? (
                    ...
                    <p>
                        {props.initialValue.hours}:{props.initialValue.minutes}
                    </p>
                ))}
            {props.type === "dropdown" &&
                (props.editOn ? (
            ...
            {props.type === "toggle2" && (props.editOn ? <ToggleWithValue options={props.options} selected={props.value} setSelected={setValue} /> : <p>{props.initialValue}</p>)}
            {props.type === "date" && (props.editOn ? <DatePicker value={props.value} setValue={setValue} disabled={props.nonEditable} /> : <p>{props.initialValue}</p>)}
            {props.error && props.error.show && <p className={EditableInputStyles.errorMessage}>{props.error.message}</p>}
        </div>
    );
};
