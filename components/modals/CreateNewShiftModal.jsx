...
import { DropDown, InputBox } from "../inputComponents/InputBox";
    ...
    return (
        <div>
            ...
            >
                ...
                {toggleShiftModal ? (
                    <div>
                        <div className={ModalStyles.shiftModalAppear}>
                            <div>
                                <p>Start Date</p>
                        ...
                        <div className={ModalStyles.smallModalUpperdiv}>
                            <div>
                                <p>In Time</p>
                                <span
                                    style={{ display: "flex" }}
                                    className={ModalStyles.modalDropDown}
                                >
                ...
                {toggleUsersLocation ? (
                    <div className={ModalStyles.shiftUserLocation}>
                        <div>
                            <p>Users</p>
                            <InputBox type="text" />
                        </div>
...
export default CreateNewShiftModal;
