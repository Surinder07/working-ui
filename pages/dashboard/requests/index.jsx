...
const Requests = (props) => {
    ...
    const fetchData = () => {
        if (props.user.role === "ADMIN" || props.user.role === "MANAGER") {
            fetchAndHandlePage(
                () => requestService.getAll(pageNo, pageSize, filters, sort),
                setData,
                setTotalEntries,
                setTotalPages,
        ...
        if (props.user.role === "EMPLOYEE" || props.user.role === "MANAGER") {
            fetchAndHandlePage(
                () => requestService.getAllForUser(pageNoMyData, pageSize, myFilters, sort),
                setMyData,
                setTotalEntriesMyData,
                setTotalPagesMyData,
                props.setPageLoading,
                props.setToasterInfo,
                getRequestsListing,
                    ...
                    <div className={DashboardStyles.dashboardTitles}>
                        ...
                        <div className={DashboardStyles.rightContainer}>
                            ...
                            {props.user.role !== "ADMIN" && (
                                <Button onClick={() => setShowAddModal(true)} type="plain">
                                    + Create Request
                                </Button>
                            )}
                        </div>
