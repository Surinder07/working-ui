    ...
    return (
        <>
            ...
            <DashboardCard style={{marginTop: "20px"}}>
                <TabularInfo title="Employee Sheet" description="Tabular list Employee details." data={data} actions={actions} pagination showSearch showFilter />
            </DashboardCard>
            <InviteUserModal setShowModal={setShowModal} showModal={showModal} setToasterInfo={props.setToasterInfo}/>
        </>
    );
};
